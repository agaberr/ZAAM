...
def get_memory_aids(user_id):
    ...
    allMemAids = MemoryAid.findByUserID(db, user_id)
...
def update_memory_aid(user_id, memory_aid_id):
    ...
    if "date_of_birth" in data:
        memAid.date_of_birth = data["date_of_birth"]
    if "date_met_patient" in data:
        memAid.date_met_patient = data["date_met_patient"]
    if "date_of_occurrence" in data:
        memAid.date_of_occurrence = data["date_of_occurrence"]
